        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <?php 
                    _navlink('Feeds', 'concept/feeds');
                    _navlink('Minimal', 'concept/minimal');
                    _navlink('Vue Test', 'concept/vuetest');
                    _navlink('Graph', 'concept/graph');

                    if($session["valid"]===true){
                        _navlink('Logout','user/logout');
                    } else {
                        _navlink('Login','user/login');
                    }
                    ?>
                </ul>
            </div>
